...
// THE PIN for the order of loadFromCLI's four cases, carrying no timing at
// all -- the sibling of linear's
// TestClassifyRun_AnAnswerInHandBeatsAContextThatIsDone, whose comment has
// the argument and the measurements, including why this is a table rather
// than a real subprocess landing in a window a loaded machine can miss.
