...
//
// Field mapping (herdr's 19-field Palette -> this package's 7-field
...
//	                            what Border draws.
//
// herdr's other twelve fields (sidebar_bg, active_row_bg, selection_bg,
// surface0, surface1, overlay0, overlay1, mauve, yellow, blue, teal, peach)
// have no equivalent in this package's smaller Palette and are not
// translated; herdr-draft does not replicate herdr's full theming model.
//
...
var builtinPalettes = map[string]Palette{
	...
	// 16-color defaults (ANSI indices 2 "green", 4 "blue", 7 "white", 8
	// "bright black", 9 "bright red"), a best-effort approximation.
	// panel_bg and text use herdr's Color::Reset, translated to
	// lipgloss.NoColor{} (no foreground/background override), the closest
	// analog to "inherit the terminal's own color".
	"terminal": {
...
// package's smaller Palette. herdr's other twelve [theme.custom] keys
// (sidebar_bg, active_row_bg, selection_bg, surface0, surface1, overlay0,
// overlay1, mauve, yellow, blue, teal, peach) and the nested
// [theme.custom.light]/[theme.custom.dark] per-appearance override tables
// have no equivalent field here and are intentionally not decoded.
