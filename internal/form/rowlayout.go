...
//
// It deliberately does NOT reuse sizes.go's innerWidth: submitview.go
// still measures itself with innerWidth, and folding the two together
// would move the two submit golden frames for no reason at all.
package form
