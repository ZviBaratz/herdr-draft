...
**Run on 2026-09-19** (Recorded runs): step 2's positive half, and steps
3 and 4, in two fresh sessions. Step 1 was the owner's own install.
**Step 2's negative half was not run**, so over-triggering onto the Agent
tool's subagents is still unchecked.
...
it does not count. Whether the numbered text holds in a real session is
unrun.
