...
| [host colours](specs/2026-09-23-host-colours-design.md) | asking the host terminal what the `terminal` palette's colours actually are, so its contrast floors apply | proposed, **not implemented** |
